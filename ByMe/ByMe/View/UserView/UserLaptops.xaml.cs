...
{
    public partial class UserLaptops : ContentPage
    {
        private UserLaptopsViewModel laptopViewModel;
        public UserLaptops()
        {
            InitializeComponent();
            Title = "Laptops";
            laptopViewModel = App.Locator.UserLaptop;
