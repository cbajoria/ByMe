...
{
    public partial class PenDrives : ContentPage
    {
        private PenDrivesViewModel pendriveViewModel;
        public PenDrives()
        {
            InitializeComponent();
            CrossConnectivity.Current.ConnectivityChanged += Current_ConnectivityChanged;
            pendriveViewModel = App.Locator.AdminPenDrives;
        ...
        {
            Navigation.PushAsync(new AddItem("Pendrive"));
        }
    }
}
